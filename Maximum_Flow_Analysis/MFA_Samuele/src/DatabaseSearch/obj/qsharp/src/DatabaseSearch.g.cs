...
namespace Quantum.DatabaseSearch
{
    public class DatabaseOracle : Adjointable<(Qubit,QArray<Qubit>)>, ICallable
    {
        ...
        String ICallable.FullName => "Quantum.DatabaseSearch.DatabaseOracle";
...
#line hidden
    ...
    public class UniformSuperposition : Adjointable<QArray<Qubit>>, ICallable
    {
        ...
        String ICallable.FullName => "Quantum.DatabaseSearch.UniformSuperposition";
...
#line hidden
    ...
    public class StatePreparation : Adjointable<(Qubit,QArray<Qubit>)>, ICallable
    {
        ...
        String ICallable.FullName => "Quantum.DatabaseSearch.StatePreparation";
...
#line hidden
    ...
    public class ReflectMarked : Operation<Qubit, QVoid>, ICallable
    {
        ...
        String ICallable.FullName => "Quantum.DatabaseSearch.ReflectMarked";
...
#line hidden
    ...
    public class XAll : Operation<QArray<Qubit>, QVoid>, ICallable
    {
        ...
        String ICallable.FullName => "Quantum.DatabaseSearch.XAll";
        protected ICallable Length
        {
            get;
            set;
...
#line hidden
    ...
    public class ReflectZero : Operation<QArray<Qubit>, QVoid>, ICallable
    {
        ...
        String ICallable.FullName => "Quantum.DatabaseSearch.ReflectZero";
        protected ICallable Length
        {
            get;
            set;
...
#line hidden
    ...
    public class ReflectStart : Operation<(Qubit,QArray<Qubit>), QVoid>, ICallable
    {
        ...
        String ICallable.FullName => "Quantum.DatabaseSearch.ReflectStart";
...
#line hidden
    ...
    public class QuantumSearch : Operation<(Int64,Qubit,QArray<Qubit>), QVoid>, ICallable
    {
        ...
        String ICallable.FullName => "Quantum.DatabaseSearch.QuantumSearch";
...
#line hidden
    ...
    public class ApplyQuantumSearch : Operation<(Int64,Int64), (Result,QArray<Result>)>, ICallable
    {
        ...
        String ICallable.FullName => "Quantum.DatabaseSearch.ApplyQuantumSearch";
